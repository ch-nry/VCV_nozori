...
struct Nozori_84_8_BITSWidget : ModuleWidget {
	Nozori_84_8_BITSWidget(Nozori_84_8_BITS* module) {
		...
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(46.1, 30.3)), module, Nozori_84_8_BITS::POT2_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(15.1, 30.3)), module, Nozori_84_8_BITS::POT1_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(15.1, 52.8)), module, Nozori_84_8_BITS::POT3_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(46.1, 52.8)), module, Nozori_84_8_BITS::POT4_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(15.1, 75.1)), module, Nozori_84_8_BITS::POT5_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(46.1, 75.1)), module, Nozori_84_8_BITS::POT6_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(15.1, 97.5)), module, Nozori_84_8_BITS::POT7_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(46.1, 97.5)), module, Nozori_84_8_BITS::POT8_PARAM));
		...
		addChild(createLightCentered<warningText_48<RedLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_84_8_BITS::TEXT_LIGHT_48));
		addChild(createLightCentered<warningText_96<RedLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_84_8_BITS::TEXT_LIGHT_96));
	}
};
