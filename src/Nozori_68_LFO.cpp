...
struct Nozori_68_LFOWidget : ModuleWidget {
	Nozori_68_LFOWidget(Nozori_68_LFO* module) {
		...
		addChild(createLightCentered<warningText_48<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_68_LFO::TEXT_LIGHT_48));
		addChild(createLightCentered<warningText_96<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_68_LFO::TEXT_LIGHT_96));
	}
};
