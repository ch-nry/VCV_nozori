...
// quad sinus oscillator with phase frequency modulation
// Pot 1 : FQ1
...
inline void sin_PM_audio_() {
  ...
  case 0 :
    ...
    out = fast_sin(sin1_phase + modulation1);
    out2 = fast_sin((sin1_phase<<1) + modulation1);
  break;
  case 1 :
    // Oscillateur 4
    //freq = (CV_filter16_out[index_filter_pot7])<<11;
    ...
    tmpS = fast_sin(sin3_phase + modulation1)^0x80000000;
    tmpS = ((tmpS>>16) * CV_filter16_out[index_filter_pot6]);
    modulation1 = tmpS >> 0;
  ...
  case 2 :
    ...
    tmpS = fast_sin(sin2_phase+modulation1)^0x80000000;
    tmpS = ((tmpS>>16) * CV_filter16_out[index_filter_pot4]);
    modulation1 = tmpS >> 0;
