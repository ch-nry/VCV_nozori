...
struct Nozori_84_HARMONICSWidget : ModuleWidget {
	Nozori_84_HARMONICSWidget(Nozori_84_HARMONICS* module) {
		...
		addChild(createLightCentered<warningText_48<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_84_HARMONICS::TEXT_LIGHT_48));
		addChild(createLightCentered<warningText_96<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_84_HARMONICS::TEXT_LIGHT_96));
	}
};
