...
struct Nozori_84_HARMONICSWidget : ModuleWidget {
	Nozori_84_HARMONICSWidget(Nozori_84_HARMONICS* module) {
		setModule(module);
		setPanel(APP->window->loadSvg(asset::plugin(pluginInstance, "res/nozori_84_HARMONICS.svg")));
		...
		addChild(createLightCentered<warningText_48<RedLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_84_HARMONICS::TEXT_LIGHT_48));
		addChild(createLightCentered<warningText_96<RedLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_84_HARMONICS::TEXT_LIGHT_96));
	}
};
