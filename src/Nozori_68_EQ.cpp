...
struct Nozori_68_EQWidget : ModuleWidget {
	Nozori_68_EQWidget(Nozori_68_EQ* module) {
		...
		addChild(createLightCentered<warningText_48<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_68_EQ::TEXT_LIGHT_48));
		addChild(createLightCentered<warningText_96<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_68_EQ::TEXT_LIGHT_96));
	}
};
