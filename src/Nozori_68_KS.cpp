...
struct Nozori_68_KSWidget : ModuleWidget {
	Nozori_68_KSWidget(Nozori_68_KS* module) {
		...
		addChild(createLightCentered<warningText_48<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_68_KS::TEXT_LIGHT_48));
		addChild(createLightCentered<warningText_96<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_68_KS::TEXT_LIGHT_96));
	}
};
