...
struct Nozori_84_SIN_WSWidget : ModuleWidget {
	Nozori_84_SIN_WSWidget(Nozori_84_SIN_WS* module) {
		setModule(module);
		setPanel(APP->window->loadSvg(asset::plugin(pluginInstance, "res/nozori_84_SIN_WS.svg")));
		...
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(46.1, 30.3)), module, Nozori_84_SIN_WS::POT2_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(15.1, 30.3)), module, Nozori_84_SIN_WS::POT1_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(15.1, 52.8)), module, Nozori_84_SIN_WS::POT3_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(46.1, 52.8)), module, Nozori_84_SIN_WS::POT4_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(15.1, 75.1)), module, Nozori_84_SIN_WS::POT5_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(46.1, 75.1)), module, Nozori_84_SIN_WS::POT6_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(15.1, 97.5)), module, Nozori_84_SIN_WS::POT7_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(46.1, 97.5)), module, Nozori_84_SIN_WS::POT8_PARAM));
