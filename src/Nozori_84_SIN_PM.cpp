...
struct Nozori_84_SIN_PMWidget : ModuleWidget {
	Nozori_84_SIN_PMWidget(Nozori_84_SIN_PM* module) {
		...
		addChild(createLightCentered<warningText_48<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_84_SIN_PM::TEXT_LIGHT_48));
		addChild(createLightCentered<warningText_96<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_84_SIN_PM::TEXT_LIGHT_96));
	}
};
