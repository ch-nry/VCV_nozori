...
struct Nozori_68_VCO_QTZWidget : ModuleWidget {
	Nozori_68_VCO_QTZWidget(Nozori_68_VCO_QTZ* module) {
		...
		addChild(createLightCentered<warningText_48<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_68_VCO_QTZ::TEXT_LIGHT_48));
		addChild(createLightCentered<warningText_96<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_68_VCO_QTZ::TEXT_LIGHT_96));
	}
};
