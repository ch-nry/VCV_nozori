...
struct Nozori_68_VCF_MORPHWidget : ModuleWidget {
	Nozori_68_VCF_MORPHWidget(Nozori_68_VCF_MORPH* module) {
		setModule(module);
		setPanel(APP->window->loadSvg(asset::plugin(pluginInstance, "res/nozori_68_VCF_MORPH.svg")));
		...
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(46.1, 30.3)), module, Nozori_68_VCF_MORPH::POT2_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(15.1, 30.3)), module, Nozori_68_VCF_MORPH::POT1_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(15.1, 52.8)), module, Nozori_68_VCF_MORPH::POT3_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(46.1, 52.8)), module, Nozori_68_VCF_MORPH::POT4_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(15.1, 75.1)), module, Nozori_68_VCF_MORPH::POT5_PARAM));
		addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(46.1, 75.1)), module, Nozori_68_VCF_MORPH::POT6_PARAM));
