...
struct Nozori_84_CLOCKWidget : ModuleWidget {
	Nozori_84_CLOCKWidget(Nozori_84_CLOCK* module) {
		...
		addChild(createLightCentered<warningText_48<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_84_CLOCK::TEXT_LIGHT_48));
		addChild(createLightCentered<warningText_96<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_84_CLOCK::TEXT_LIGHT_96));
	}
};
