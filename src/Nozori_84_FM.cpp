...
struct Nozori_84_FMWidget : ModuleWidget {
	Nozori_84_FMWidget(Nozori_84_FM* module) {
		...
		addChild(createLightCentered<warningText_48<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_84_FM::TEXT_LIGHT_48));
		addChild(createLightCentered<warningText_96<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_84_FM::TEXT_LIGHT_96));
	}
};
