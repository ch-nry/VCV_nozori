...
struct Nozori_allWidget : ModuleWidget {
	Nozori_allWidget(Nozori_all* module) {
		...
		addChild(createLightCentered<warningText_48<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_all::TEXT_LIGHT_48));
		addChild(createLightCentered<warningText_96<NoLight>>(mm2px(Vec(30.5, 64.3)), module, Nozori_all::TEXT_LIGHT_96));
	}
};
