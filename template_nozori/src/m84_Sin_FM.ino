...
// quad sinus oscillator with exponential frequency modulation
// Pot 1 : FQ1
...
inline void sin_FM_audio_() {
  ...
  case 3 :
    ...
    increment1 = increment_4;
    sin4_phase += increment1<<3; 
    tmpS = (sin4_phase & 0x80000000)+0x07FFFFFF; // square
    tmpS = ((tmpS>>16) * CV_filter16_out[index_filter_pot8]);
    modulation1 = tmpS >> 6;
    ...
    increment1 = increment_3;
    sin3_phase += increment1<<3; 
    tmpS = sin3_phase ^ 0x80000000; // saw
    tmpS = ((tmpS>>16) * CV_filter16_out[index_filter_pot6]);
    modulation1 += tmpS >> 6;
    ...
    increment1 = increment_2;
    sin2_phase += increment1<<3; 
    tmpS = fast_sin(sin2_phase)^0x80000000; // sin
    tmpS = ((tmpS>>16) * CV_filter16_out[index_filter_pot4]);
    modulation1 += tmpS >> 6;
  ...
  case 4 :
    ...
    increment1 = increment_2;
    sin2_phase += increment1<<3; 
    tmpS = -(sin2_phase^0x80000000); //reverse saw
    tmpS = ((tmpS>>16) * CV_filter16_out[index_filter_pot4]);
    modulation1 += tmpS >> 6;
